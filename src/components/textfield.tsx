...
export default function TextField({
  ...
  const inputClasses = cn(
    "w-full border border-gray-300 bg-white rounded-lg py-4 pl-10 pr-4 outline-none focus:border-purple-600 focus:shadow-lg focus:shadow-purple-600/20",
    {
